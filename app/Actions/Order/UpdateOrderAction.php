...
class UpdateOrderAction
{
    ...
    protected function prepare_update_order_dto($order, CalculationResultDTO $calculated_result, UpdateOrderPayloadDTO $dto, CalculationContextDTO $context, float $exchange_rate)
    {
        ...
        $order_dto->invoiced_subtotal = $this->convert_amount($calculated_result->subtotal, $dto->currency_code, $order_dto->exchange_rate);
        $order_dto->base_subtotal = $calculated_result->subtotal;

        $order_dto->invoiced_shipping_total = $this->convert_amount($calculated_result->shipping_total, $dto->currency_code, $order_dto->exchange_rate);
        $order_dto->base_shipping_total = $calculated_result->shipping_total;

        $order_dto->invoiced_discount_total = $this->convert_amount($calculated_result->discount_total, $dto->currency_code, $order_dto->exchange_rate);
        ...
        $order_dto->invoiced_tax_total = $this->convert_amount($calculated_result->tax_total, $dto->currency_code, $order_dto->exchange_rate);
        $order_dto->base_tax_total = $calculated_result->tax_total;

        $order_dto->invoiced_total = $this->convert_amount($calculated_result->total, $dto->currency_code, $order_dto->exchange_rate);
