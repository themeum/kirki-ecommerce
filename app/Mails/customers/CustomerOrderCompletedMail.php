...
/**
 * Email sent to a customer when their order is completed.
 *
 * @since 1.0.0
 */
class CustomerOrderCompletedMail extends Mailer
{
    /** @var Order */
    protected $order;
    ...
    {
        return 'customer_emails.order_notifications.order_completed';
    }
