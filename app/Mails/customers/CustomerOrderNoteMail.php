...
/**
 * Email sent to a customer when a note is added to their order.
 *
 * @since 1.0.0
 */
class CustomerOrderNoteMail extends Mailer
{
    /** @var Order */
    protected $order;
    ...
    {
        return 'customer_emails.order_notifications.order_note';
    }
