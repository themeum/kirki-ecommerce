...
/**
 * Email sent to a customer when their order is put on hold.
 *
 * @since 1.0.0
 */
class CustomerOrderOnHoldMail extends Mailer
{
    /** @var Order */
    protected $order;
    ...
    {
        return 'customer_emails.order_notifications.order_on_hold';
    }
