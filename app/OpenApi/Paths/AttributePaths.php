 ...
 *     path="/attributes",
 *     tags={"Catalog"},
 *     summary="List Attribute records",
 ...
 *                 property="data",
 *                 type="object",
 *                 @OA\Property(property="results", type="array", @OA\Items(ref="#/components/schemas/AttributeResource")),
 ...
 *     security={{"wpCookieAuth": {}}},
 *     @OA\RequestBody(required=true, @OA\JsonContent(ref="#/components/schemas/CreateAttributeDTO")),
 *     @OA\Response(
 *         response=201,
 *         description="Created",
 *         @OA\JsonContent(
 ...
 *     security={{"wpCookieAuth": {}}},
 *     @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")),
 *     @OA\RequestBody(required=true, @OA\JsonContent(ref="#/components/schemas/UpdateAttributeDTO")),
 *     @OA\Response(
 *         response=200,
 *         description="Updated",
 *         @OA\JsonContent(
 ...
 *
 * @OA\Post(
 *     path="/attributes/bulk",
 *     tags={"Catalog"},
 *     summary="Bulk actions for Attribute",
 *     operationId="Attribute_bulk_actions",
 *     security={{"wpCookieAuth": {}}},
