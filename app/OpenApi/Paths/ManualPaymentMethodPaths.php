 ...
 *                 property="data",
 *                 type="object",
 *                 @OA\Property(property="results", type="array", @OA\Items(ref="#/components/schemas/PaymentMethodListResource")),
 ...
 *     operationId="PaymentMethod_show",
 *     security={{"wpCookieAuth": {}}},
 ...
 *         @OA\JsonContent(
 *             type="object",
 *             @OA\Property(property="data", ref="#/components/schemas/PaymentMethodResource"),
 *             @OA\Property(property="message", type="string")
 *         )
 *     ),
 ...
 *     security={{"wpCookieAuth": {}}},
 *     @OA\RequestBody(required=true, @OA\JsonContent(ref="#/components/schemas/CreatePaymentMethodDTO")),
 *     @OA\Response(
 *         response=201,
 *         description="Created",
 *         @OA\JsonContent(
 ...
 *     operationId="PaymentMethod_update",
 *     security={{"wpCookieAuth": {}}},
 *     @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")),
 *     @OA\RequestBody(required=true, @OA\JsonContent(ref="#/components/schemas/UpdatePaymentMethodDTO")),
 *     @OA\Response(
 *         response=200,
 *         description="Updated",
 *         @OA\JsonContent(
 ...
 *     tags={"Payments"},
 *     summary="Bulk actions for PaymentMethod",
 *     operationId="PaymentMethod_bulk_actions",
 *     security={{"wpCookieAuth": {}}},
 ...
 * @since 1.0.0
 */
class ManualPaymentMethodPaths
{
}
