...
/**
 * Creates the kirki_ecommerce_addresses table, which stores customer addresses.
 *
 * @since 1.0.0
 */
...
{
    /**
     * Create the kirki_ecommerce_addresses table.
     *
     * @since 1.0.0
     *
     * @return void
    ...
    /**
     * Drop the kirki_ecommerce_addresses table.
     *
     * @since 1.0.0
     *
     * @return void
