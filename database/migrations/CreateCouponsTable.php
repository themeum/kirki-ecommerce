...
class CreateCouponsTable implements Migration
{
    public function up()
    {
        Schema::create('kirki_ecommerce_coupons', function (Structure $table) {
            ...
            $table->enum('customer_include_eligibility', ['none', 'all', 'specific-customers', 'specific-groups'])->default('all');
            $table->enum('customer_exclude_eligibility', ['none', 'all', 'specific-customers', 'specific-groups'])->default('none');
