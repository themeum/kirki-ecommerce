 ...
 * @var string
 */
define('KIRKI_ECOMMERCE_VERSION', '1.0.0');

/**
 * The kirki ecommerce plugin is in development mode
 * @var bool
 */
define('KIRKI_ECOMMERCE_IS_DEV', true);
 ...
 * @var string
 */
define('KIRKI_ECOMMERCE_PLUGIN_PATH', plugin_dir_path(__FILE__));
...
register_activation_hook(KIRKI_ECOMMERCE_PLUGIN_PATH, [KirkiEcommerce::class, 'handle_activation']);
register_deactivation_hook(KIRKI_ECOMMERCE_PLUGIN_PATH, [KirkiEcommerce::class, 'handle_deactivation']);
register_uninstall_hook(KIRKI_ECOMMERCE_PLUGIN_PATH, [KirkiEcommerce::class, 'handle_uninstallation']);
