...
/**
 * Eway Rapid API response and error codes.
 *
 * Eway returns these in two places:
 *  - the `Errors` field of a request response, as a comma separated list,
 *    when a payload fails validation (the HTTP status is still 200);
 *  - the `ResponseCode` / `ResponseMessage` fields of a completed transaction.
 *
...
class EwayErrorCode
{
    ...
    const ERROR_CODES = [
        ...
        // Declined — the issuing bank refused the transaction.
        ...
        'D4465' => 'Withdrawal Frequency Limit Exceeded',
        ...
        // Fraud — blocked by Beagle or a custom fraud rule.
        ...
        // System — gateway, connection or SDK level problems.
        'S5000' => 'System Error',
        ...
        // Validation — the request payload was rejected.
        ...
        'V6179' => 'Invalid Apple Pay request, Apple Pay isnt available in your country',
        ...
        // 3D Secure — problems during cardholder authentication.
    ...
    /**
     * Resolve a single code to its message.
     *
     * @param string $code A single Eway response code, e.g. "V6011".
     * @return string The message, or the original code if it is unrecognised.
     */
