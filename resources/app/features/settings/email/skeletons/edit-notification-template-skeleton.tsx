...
const EditNotificationTemplateSkeleton = () => (
  <Page>
    <PageHeading hasBack leftIcon={<MailIcon />} text={__('Notification Template', 'kirki-ecommerce')} />
    <PageContent containerSize="xl" cssOverride={emailTemplateStyles.container}>
      <Flex gap={12} cssOverride={{ width: '100%' }}>
        <Flex direction="column" gap={5} cssOverride={{ width: '40%' }}>
          <SettingsPageSkeleton cards={[3, 5, 3]} />
        </Flex>
...
EditNotificationTemplateSkeleton.displayName = 'EditNotificationTemplateSkeleton';

export default EditNotificationTemplateSkeleton;
