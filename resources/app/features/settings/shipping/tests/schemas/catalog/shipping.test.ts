...
import { ShippingBoxSchema, ShippingProfileSchema, ShippingZoneSchema } from '@/features/settings/shipping/schemas/catalog/shipping';
  ...
  const documentedZone = {
    ...
    shipping_methods: [
      ...
      },
      {
        ...
        type: 'weight',
        ranges: [
          { from: 0, to: 1, base_amount: 5 },
          { from: 1, to: 2, base_amount: 10 },
        ],
        base_amount: 30,
        is_taxable: false,
        description: null,
