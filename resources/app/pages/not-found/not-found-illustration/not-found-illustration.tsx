...
const NotFoundIllustration = () => {
  return (
    <svg
      className={`${CLASS_PREFIX}-not-found-illustration-svg`}
      viewBox="0 0 440 360"
      fill="none"
    ...
    >
      <ellipse
        ...
        rx="176"
        ry="18"
        fill="var(--decom-border-border-secondary)"
        fillOpacity="0.4"
      />
      <path
        d="M118 298H322"
      ...
      <path
        ...
        fill="var(--decom-background-bg-fill-secondary)"
      />
      <rect
        x="248"
        y="248"
        ...
        height="52"
        rx="4"
        fill="var(--decom-text-text-primary)"
        fillOpacity="0.75"
      />
      <path
        d="M258 170C246 188 238 210 234 232"
        stroke="var(--decom-text-text-primary)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeOpacity="0.35"
      />
      ...
      <path
        ...
        stroke="var(--decom-color-brand-3)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeOpacity="0.55"
      />
