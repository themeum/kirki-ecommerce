...
const DrowdownPreview = () => {
  ...
  const [openDropdownSubmenu, setOpenDropdownSubmenu] = useState(false);
  const triggerRef = useRef(null);
  const triggerSubmenuRef = useRef(null);
      ...
      <Dropdown>
        ...
        >
          ...
          >
            <DropdownMenuItem
              leftIcon={<ButtonDefaultIcon />}
              onClick={toggleDropdownSubmenu}
            >
              Email
            </DropdownMenuItem>

            <DropdownMenuItem onClick={toggleDropdownSubmenu}>
              Message
            </DropdownMenuItem>
            <Separator />
