...
<div class="kecom-cart-item-quantity">
    <div class="kecom-quantity">
        ...
        <button class="kecom-quantity-btn" type="button" aria-label="Increase" @click.debounce.200ms="increment" :disabled="max !== undefined && quantity >= max"> <?php Icon::render('plus'); ?></button>
    </div>
