...
<div class="kecom-cart-item-quantity">
    <div class="kecom-quantity kecom-quantity-sm">
        ...
        <input class="kecom-quantity-input" type="number" :value="quantity" @input.debounce.200ms="setValue($el.value, $el)" @change="handleBlur($el)" min="1" max="<?php echo esc_html($max_quantity); ?>" aria-label="Quantity">
