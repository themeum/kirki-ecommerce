...
<style>
    ...
    .kds .kds-swatch-color {
        height: 56px;
    }

    .kds .kds-swatch-label {
        padding: .375rem .5rem;
        background: #fff;
        color: #52525b;
        font-weight: 500;
...
<div class="kds">
    ...
    <section>
        ...
        <div class="kds-swatch-grid">
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-brand,hsl(214 100% 54%))"></div>
                <div class="kds-swatch-label">Brand</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-brand-hover,hsl(214 83% 50%))"></div>
                <div class="kds-swatch-label">Brand Hover</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-brand-light,hsl(214 100% 95%))"></div>
                <div class="kds-swatch-label">Brand Light</div>
            </div>
        </div>
        <p class="kds-label">Semantic</p>
        <div class="kds-swatch-grid">
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-success,hsl(145 36% 44%))"></div>
                <div class="kds-swatch-label">Success</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-success-bg,hsl(141 100% 95%))"></div>
                <div class="kds-swatch-label">Success BG</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-error,hsl(0 100% 42%))"></div>
                <div class="kds-swatch-label">Error</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-error-bg,hsl(2 100% 95%))"></div>
                <div class="kds-swatch-label">Error BG</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-warning,hsl(42 100% 18%))"></div>
                <div class="kds-swatch-label">Warning</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-warning-bg,hsl(38 100% 92%))"></div>
                <div class="kds-swatch-label">Warning BG</div>
            </div>
        </div>
        <p class="kds-label">Neutrals</p>
        <div class="kds-swatch-grid">
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-bg,#fff)"></div>
                <div class="kds-swatch-label">BG</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-bg-alt,hsl(248 23% 96%))"></div>
                <div class="kds-swatch-label">BG Alt</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-bg-hover,hsl(248 20% 94%))"></div>
                <div class="kds-swatch-label">BG Hover</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-border,hsl(252 14% 90%));border:none"></div>
                <div class="kds-swatch-label">Border</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-text,hsl(255 4% 20%))"></div>
                <div class="kds-swatch-label">Text</div>
            </div>
            <div class="kds-swatch">
                <div class="kds-swatch-color" style="background:var(--kecom-color-text-muted,hsl(249 10% 72%))"></div>
                <div class="kds-swatch-label">Text Muted</div>
            </div>
        </div>
    </section>
        ...
        <div class="kds-card-grid">
            ...
            <div class="kecom-product-card">
                ...
                <div class="kecom-product-card-footer">
                    ...
                    <button class="kecom-btn kecom-btn-primary kecom-btn-sm kecom-product-card-add-to-cart">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4" d="M1.366 1.366H2.7l1.773 8.28A1.334 1.334 0 0 0 5.806 10.7h6.52a1.33 1.33 0 0 0 1.3-1.046l1.1-4.953H3.413M6 14a.667.667 0 1 1-1.334 0A.667.667 0 0 1 6 14m7.333 0a.667.667 0 1 1-1.334 0 .667.667 0 0 1 1.334 0" />
                        </svg>
                        Add
                    </button>
                </div>
...
<script>
    function showToast(type, position = 'bottom-right') {
        ...
        if (window.kecomToast) {
            if (type === 'success') {
                window.kecomToast.success(messages[type], undefined, {
                    position
                });
            } else if (type === 'error') {
                window.kecomToast.error(messages[type], undefined, {
                    position
                });
            } else if (type === 'warning') {
                window.kecomToast.warning(messages[type], undefined, {
                    position
                });
            } else {
                window.kecomToast.info(messages[type], undefined, {
                    position
                });
            }
        }
