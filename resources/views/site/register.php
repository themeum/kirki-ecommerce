...
<div class="kecom-auth-container">
    <div class="kecom-auth-form-wrapper">
        <div class="kecom-auth-header">
            <h3 class="kecom-auth-header-title"><?php esc_html_e('Sign up', 'kirki-ecommerce'); ?></h3>
            <div class="kecom-auth-header-content">
                <span><?php esc_html_e('Already have an account?', 'kirki-ecommerce'); ?></span>
                <a href="<?php echo esc_url(Url::get_login_url()); ?>">
                    <?php esc_html_e('Login', 'kirki-ecommerce'); ?>
                </a>
            </div>
            <!-- Errors -->
        ...
        <form class="kecom-auth-form" x-data="form({
            ...
            <div class="kecom-field" :class="errors.first_name ? 'kecom-field-error-state' : ''">
                ...
                <input class="kecom-input" type="text" id="kecom-first-name" name="first_name" x-bind="<?php echo esc_attr(sprintf("register('first_name', {
                    required: '%s'
            ...
            <div class="kecom-field" :class="errors.last_name ? 'kecom-field-error-state' : ''">
                ...
                <input class="kecom-input" type="text" id="kecom-last-name" name="last_name" x-bind="<?php echo esc_attr(sprintf("register('last_name', {
                    required: '%s'
            ...
            <div class="kecom-field" :class="errors.email ? 'kecom-field-error-state' : ''">
                ...
                <input class="kecom-input" type="email" id="kecom-email" name="email" x-bind="<?php echo esc_attr(sprintf("register('email', {
                    required: '%s',
                    email: true
            ...
            <div class="kecom-field" :class="errors.password ? 'kecom-field-error-state' : ''">
                ...
                <div class="kecom-password-input" x-data="{ showPassword: false }">
                    <input class="kecom-input" :type="showPassword ? 'text' : 'password'" id="kecom-password" name="password" x-bind="<?php echo esc_attr(sprintf("register('password', {
                    required: '%s',
                    minLength: { value: 8, message: '%s' }
                })", __('Password is required', 'kirki-ecommerce'), __('Minimum password length is 8 characters', 'kirki-ecommerce'))); ?>" placeholder="<?php esc_html_e('Type your password', 'kirki-ecommerce'); ?>">
            ...
            <div class="kecom-field" :class="errors.password_confirmation ? 'kecom-field-error-state' : ''">
                ...
                <div class="kecom-password-input" x-data="{ showPassword: false }">
                    <input class="kecom-input" :type="showPassword ? 'text' : 'password'" id="kecom-password_confirmation" name="password_confirmation" x-bind="<?php echo esc_attr(sprintf("register('password_confirmation', {
                    required: '%s',
                    validate: (value) => value === values.password || '%s'
                })", __('Confirm password is required', 'kirki-ecommerce'), __('Password does not match', 'kirki-ecommerce'))); ?>" placeholder="<?php esc_html_e('Confirm your password', 'kirki-ecommerce'); ?>">
                    <template x-if="showPassword">
                        <span class="kecom-password-input-show" @click="showPassword = false"><?php Icon::render('eye'); ?></span>
                    </template>
                    <template x-if="!showPassword">
